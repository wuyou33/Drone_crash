...
dv = 0.1; da = 0.001; dw = 0.01;

dLDMdv = (func_LDM(v+dv,a,w)-LDM)/dv;
dLDMda = (func_LDM(v,a+da,w)-LDM)/da;
dLDMdw = (func_LDM(v,a,w+dw)-LDM)/dw;
...
A = ... 
[ 0,                                                                        0,                                                                 cot(r)^2 + 1,                  0,             0,                  0;
  0,                        Dv/(m*v*sin(r)) - (g*m*sin(r) + D)/(m*v^2*sin(r)),             (g*cos(r))/(v*sin(r)) - (cos(r)*(g*m*sin(r) + D))/(m*v*sin(r)^2),    Da/(m*v*sin(r)),             0,    Dw/(m*v*sin(r));
